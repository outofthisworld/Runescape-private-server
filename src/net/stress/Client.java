...
public class Client {
    ...
    public void attemptLogin() throws Exception {
        ...
        socketStream = new BufferedConnection(openSocket(NetworkConfig.PORT));
        ...
        if (response == LoginProtocolConstants.LOGIN_SUCCESS) {
            FloodMain.flooder.clients.put(username, this);
