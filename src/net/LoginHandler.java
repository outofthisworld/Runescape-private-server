...
public final class LoginHandler {
    ...
    public static void login(Client c, int packetOpcode, InputBuffer in) throws Exception {
        ...
        case LoginHandler.RECONNECT:
            ...
            //Send response 3 if wrong
            //send response 4 if disabled
            ...
            if (returnCode == 2) {
                CompletableFuture.supplyAsync(() -> {
                    return "";
                }).thenRun(() -> LoginHandler.sendResponse(c, 2, 0));
    ...
    private static void sendResponse(Client c, int returnCode, int playerRights) {
